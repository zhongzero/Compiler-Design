...
public class HelloParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, ID=4, INT=5, NEWLINE=6, MUL=7, DID=8, ADD=9, SUB=10, 
		WS=11;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "ID", "INT", "NEWLINE", "MUL", "DID", "ADD", 
			"SUB", "WS"
		};
	}
	...
	public static class MulDivContext extends ExprContext {
		...
		public TerminalNode DID() { return getToken(HelloParser.DID, 0); }

...
@b_addr_1 = global i1* null, align 8
...
func_end_block_1:                                 ; preds = %normal_block_5, %normal_block_3
...
for_body_block_1:                                 ; preds = %for_condition_block_1
  ...
  store i1 true, i1* %gep_1, align 1
...
for_update_block_2:                               ; preds = %normal_block_4
...
if_body_block_1:                                  ; preds = %for_body_block_2
...
normal_block_4:                                   ; preds = %if_body_block_1, %for_body_block_2
...
func_end_block_2:                                 ; preds = %normal_block_6
  ret void

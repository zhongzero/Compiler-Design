...
@a_addr_1 = global i32* null, align 8
@const_string_1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
...
for_condition_block_2:                            ; preds = %for_update_block_2, %normal_block_2
...
normal_block_3:                                   ; preds = %for_condition_block_2
...
for_condition_block_3:                            ; preds = %for_update_block_3, %normal_block_3
...
for_body_block_3:                                 ; preds = %for_condition_block_3
...
for_update_block_3:                               ; preds = %for_body_block_3
  %load_36 = load i32, i32* %i_addr_1, align 4
  %add_3 = add i32 %load_36, 1
  store i32 %add_3, i32* %i_addr_1, align 4
  br label %for_condition_block_3

normal_block_4:                                   ; preds = %for_condition_block_3
  store i32 0, i32* %i_addr_1, align 4
  br label %for_condition_block_4

for_condition_block_4:                            ; preds = %for_update_block_4, %normal_block_4
...
for_body_block_4:                                 ; preds = %for_condition_block_4
...
func_end_block_2:                                 ; preds = %normal_block_7
  ret void

normal_block_7:                                   ; preds = %func_begin_block_2
